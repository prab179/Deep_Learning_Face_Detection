...
classifier = cv2.CascadeClassifier(r"D:\Class lectures\AI ML Internship\Facedetection system\haarcascade_frontalface_default.xml")
...
if len(data)== 100:
    name = input("Enter Face holder name : Prabhat")
    for i in range(100):
